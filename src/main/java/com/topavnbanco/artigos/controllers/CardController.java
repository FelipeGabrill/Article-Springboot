...
public class CardController {
    ...
    @Operation(
            ...
            description = "Retrieve all card with optional filters and pagination",
            responses = {
                    @ApiResponse(responseCode = "200", description = "OK")
            }
    )
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @GetMapping
    public ResponseEntity<Page<CardDTO>> findByAll(Pageable pageable) {
        Page<CardDTO> dto = service.findAll(pageable);
        return ResponseEntity.ok(dto);
    }

    @Operation(
            summary = "Create a new Card",
            description = "Register a new card in the system",
            responses = {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PostMapping
    public ResponseEntity<CardDTO> insert(@Valid @RequestBody CardDTO dto) {
    ...
    @Operation(
            ...
            description = "Delete a card by its unique identifier",
            responses = {
