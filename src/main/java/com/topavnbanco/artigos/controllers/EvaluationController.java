...
public class EvaluationController {
    ...
    @Operation(
            ...
            description = "Register a new evaluation in the system",
            responses = {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PostMapping
    public ResponseEntity<EvaluationDTO> insert(@Valid @RequestBody EvaluationDTO dto) {
    ...
    @Operation(
            ...
            description = "Update the details of an existing evaluation",
            responses = {
                    @ApiResponse(responseCode = "200", description = "OK"),
                    @ApiResponse(responseCode = "400", description = "Bad Request"),
                    @ApiResponse(responseCode = "401", description = "Unauthorized"),
