package com.topavnbanco.artigos.adapters.inbound.dtos.congresso;
...
@NoArgsConstructor
@Getter
public class CongressoSimpleDTO {

    @Schema(description = "Identificador único do congresso", example = "1", accessMode = Schema.AccessMode.READ_ONLY)
    private Long id;

    @Schema(description = "Nome do congresso", example = "Congresso Internacional de IA")
    ...
    public CongressoSimpleDTO(Congresso entity) {
